...
<div class="layui-container">
    <div class="admin-login-background">
        <div class="layui-form login-form">
            <form class="layui-form serverlog-login-form" action="{{ admin_url('passport/login') }}" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="captcha-img">
                        <img id="captchaPic" 
                            class="js-change-captcha" 
                            title="点击刷新验证码" 
                            src="images/captcha.png" 
                            data-href="/admin/passport/captcha" />
                    </div>
                </div>
                <div class="layui-form-item">
...
<script>
    layui.use(['form'], function () {
        ...
        $('body').on('click', '.js-change-captcha', function() {
        ...
        setTimeout(function() {
            $(".js-change-captcha").trigger("click");
        }, 50);
            ...
            $.post(href, {
                ...
                if (data.code == 0) {
                    layer.msg('登录成功', function () {
                        window.location = "{{ admin_url('index') }}";
                    });
                } else {
