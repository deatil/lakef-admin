                                    ...
                                    <div class="layui-col-xs6">
                                        <div class="panel layui-bg-number">
                                            <div class="panel-body">
                                                ...
                                                <div class="panel-content">
                                                    <h1 class="no-margins"> {{ $counts['attachment'] }}</h1>
                                                    <small>系统附件数量</small>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="layui-card-body">
                            <div class="welcome-module">
                                <div class="layui-row layui-col-space10 layuimini-qiuck">
                                    ...
                                    <div class="layui-col-xs3 layuimini-qiuck-module">
                                        <a href="javascript:;" layuimini-content-href="{{ admin_url('attachment/index') }}" data-title="权限菜单" data-icon="fa fa-window-maximize">
                                            <i class="fa fa-file-o"></i>
                                            <cite>附件</cite>
                                        </a>
                                    </div>
                                    <div class="layui-col-xs3 layuimini-qiuck-module">
                                        <a href="javascript:;" layuimini-content-href="{{ admin_url('operation-log/index') }}" data-title="权限菜单" data-icon="fa fa-window-maximize">
                                            <i class="fa fa-bookmark-o"></i>
                                            <cite>日志</cite>
                                        </a>
                                    </div>
                                    <div class="layui-col-xs3 layuimini-qiuck-module">
                                        <a href="javascript:;" layuimini-content-href="{{ admin_url('server-log/logs/index') }}" data-title="权限菜单" data-icon="fa fa-window-maximize">
