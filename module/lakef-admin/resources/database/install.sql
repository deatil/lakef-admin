...
DROP TABLE IF EXISTS `pre__model_has_permissions`;
CREATE TABLE `pre__model_has_permissions` (
...
DROP TABLE IF EXISTS `pre__model_has_roles`;
CREATE TABLE `pre__model_has_roles` (
...
DROP TABLE IF EXISTS `pre__permissions`;
CREATE TABLE `pre__permissions` (
...
DROP TABLE IF EXISTS `pre__role_has_permissions`;
CREATE TABLE `pre__role_has_permissions` (
  `permission_id` bigint(20) unsigned NOT NULL,
  `role_id` bigint(20) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `pre__roles`;
CREATE TABLE `pre__roles` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `pre__serverlog_app`;
CREATE TABLE `pre__serverlog_app` (
  `id` char(16) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT 'id',
  `name` varchar(150) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `app_id` varchar(20) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `app_secret` char(32) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `pre__serverlog_log`;
CREATE TABLE `pre__serverlog_log` (
  ...
  `add_ip` varchar(50) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '添加IP',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `app_id` (`app_id`)
