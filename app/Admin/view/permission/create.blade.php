...
<div class="layuimini-main">
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="url" lay-verify="required" lay-reqtext="请求链接不能为空" placeholder="请输入请求链接" autocomplete="off" class="layui-input">
            </div>
            <div class="layui-input-block">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="layui-inline w200">
                    <input type="text" name="icon" autocomplete="off" lay-verify="required" lay-reqtext="菜单图标不能为空" placeholder="菜单图标" class="layui-input" value="">
                </div>
